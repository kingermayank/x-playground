export const experiments = [
  {
    ...
    href: './experiments/lenticular-index/',
    accent: '#d8ff36',
    preview: 'lenticular',
  },
  {
    ...
    href: './experiments/signal-descent/',
    accent: '#a8ff76',
    preview: 'signal',
  },
  {
    ...
    href: './experiments/temporal-slit/',
    accent: '#dfff37',
    preview: 'slit',
  },
  {
    ...
    href: './experiments/chromatic-press/',
    accent: '#00a9ce',
    preview: 'press',
  },
  {
    ...
    href: './experiments/contour-chorus/',
    accent: '#ff674c',
    preview: 'contour',
  },
  {
    ...
    href: './experiments/config-signal-loom/',
    accent: '#8a63ff',
    preview: 'loom',
  },
  {
    ...
    href: './experiments/civic-burst-field/',
    accent: '#ff5d2e',
    preview: 'burst',
  },
  {
    ...
    href: './experiments/command-gravity/',
    accent: '#111827',
    preview: 'command',
  },
  {
  ...
  },
  {
    ...
    href: './experiments/crease-memory/',
    accent: '#d9ff57',
    preview: 'crease',
  },
];
